...
public class Packager {
    ...
    static void HandleExampleBundle() {
        ...
        //AddBuildMap("Login" + AppConst.ExtName, "*.unity", "Assets/Resources/Login");
        AddBuildMap("Scenes" + AppConst.ExtName, "*.unity", "Assets/Resources/Scenes");
        AddBuildMap("Sounds" + AppConst.ExtName, "*.mp3", "Assets/Resources/Sounds");
        AddBuildMap("Canvas" + AppConst.ExtName, "*.prefab", "Assets/Resources");
        AddBuildMap("Texture" + AppConst.ExtName, "*.png", "Assets/Resources/Texture");
