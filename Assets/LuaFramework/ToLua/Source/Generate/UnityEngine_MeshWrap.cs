...
public class UnityEngine_MeshWrap
{
	...
	static int SetUVs(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes<System.Collections.Generic.List<UnityEngine.Vector4>>(L, 3))
			{
				UnityEngine.Mesh obj = (UnityEngine.Mesh)ToLua.CheckObject(L, 1, typeof(UnityEngine.Mesh));
	...
	static int SetColors(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<System.Collections.Generic.List<UnityEngine.Color32>>(L, 2))
			{
				UnityEngine.Mesh obj = (UnityEngine.Mesh)ToLua.CheckObject(L, 1, typeof(UnityEngine.Mesh));
			...
			else if (count == 2 && TypeChecker.CheckTypes<System.Collections.Generic.List<UnityEngine.Color>>(L, 2))
			{
				UnityEngine.Mesh obj = (UnityEngine.Mesh)ToLua.CheckObject(L, 1, typeof(UnityEngine.Mesh));
	...
	static int SetTriangles(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes<System.Collections.Generic.List<int>, int>(L, 2))
			{
				UnityEngine.Mesh obj = (UnityEngine.Mesh)ToLua.CheckObject(L, 1, typeof(UnityEngine.Mesh));
