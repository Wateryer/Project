...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		BoxControWrap.Register(L);
		BoxInvisibleWrap.Register(L);
		ViewWrap.Register(L);
		BaseWrap.Register(L);
		...
		L.AddPreLoad("UnityEngine.MeshFilter", LuaOpen_UnityEngine_MeshFilter, typeof(UnityEngine.MeshFilter));
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int LuaOpen_UnityEngine_MeshFilter(IntPtr L)
	{
		try
		{
			LuaState state = LuaState.Get(L);
			state.BeginPreModule("UnityEngine");
			UnityEngine_MeshFilterWrap.Register(state);
			int reference = state.GetMetaReference(typeof(UnityEngine.MeshFilter));
			state.EndPreModule(L, reference);
			return 1;
		}
		catch(Exception e)
